                ...
                else
                {
                    ...
                    switch (mnu.SelectedValue)
                    {
                        ...
                        case "copy":
                           ...
                           // ScriptManager.RegisterStartupScript(udpSplitter, GetType(), "renameitem", "openCopyWindow(" + ModuleID + "," + OrigID + "," + UserID + ",false);", true);
                            break;
                        case "delete":
                            if (ModuleID == 1)
                            {
                    ...
                    if (Request.Cookies[FormsAuthentication.FormsCookieName] != null)
                    {
                        ...
                        if (btnEdit.ImageUrl == "~/images/checkout.png")
                        {
                            ...
                            try
                            {
                                ...
                                using (FileStream source = File.Open(DocsPath + editIDFileName, FileMode.Open))
                                {
