...
<body class="recordBody">
    <form id="form1" runat="server">
        ...
        <div id="topBar">
            <div class="toolbar">
                ...
                <asp:Panel ID="pnlClose" runat="server" CssClass="toolbarButton" meta:resourcekey="pnlCloseResource1">
                    <asp:ImageButton ID="BtnClose" runat="server" ImageUrl="~/images/exit.png" OnClientClick="closeP3Window()" CommandArgument="Close" ToolTip="Close Record" meta:resourcekey="BtnCloseResource1" />
                    <br />
        ...
        <div id="pnlRecordHeader">
            <table>
                ...
                <tr>
                    ...
                    <td style="height: 24px; width: 580px; text-align: left;">
                        <asp:TextBox ID="txtResponsibleData" runat="server"  TextMode="Multiline" Width="570px" ReadOnly="True" CssClass="ro_TitleControl" style="resize: none;" meta:resourcekey="txtResponsibleDataResource1" />
                    </td>
                    ...
                    <td>
                        <asp:Label ID="lblExpectedCompletionData" runat="server" CssClass="recordLabel" Font-Size="X-Small" meta:resourcekey="lblExpectedCompletionDataResource1" />
                    </td>
                </tr>
            </table>
        </div>
            ...
            <table style="padding: 0;">
                <tr>
                    <td style="width: 80px; padding: 10px 0 0 40px; vertical-align: top;">
                        <asp:Label ID="lblStep" runat="server" Text="Select Step:" CssClass="recordLabel" meta:resourcekey="lblStepResource1" />
                    </td>
        ...
        <div id="pnlRecordStepName">
            ...
            <asp:Panel ID="pnlInstructions" runat="server" CssClass="pnlInstructions" meta:resourcekey="pnlInstructionsResource1">
                <asp:TextBox ID="txtInstructions" runat="server" TextMode="MultiLine" meta:resourcekey="txtInstructionsResource1" />
            </asp:Panel>
        </div>
            ...
            <table style="width: 100%; padding: 0px; border: 0px solid Black;">
                <tr>
                    <td style="width: 150px; vertical-align: middle;">
                        ...
                        <asp:ConfirmButtonExtender ID="cbeFinishStep" runat="server" ConfirmText="Finish Step:  Continue with the current operation?" TargetControlID="BtnFinishStep" BehaviorID="cbeFinishStep" />
                    </td>
                    ...
                    <td style="width: 300px; text-align: left; vertical-align: middle;">
                        <asp:Button ID="BtnNotApplicable" runat="server" Text="Step Not Applicable" Width="140px" OnClick="BtnNotApplicable_Click" meta:resourcekey="BtnNotApplicableResource1" />
                        <asp:ConfirmButtonExtender ID="cbeNotApplicable" runat="server" ConfirmText="Step Not Applicable:  Continue with the current operation?" TargetControlID="BtnNotApplicable" BehaviorID="cbeNotApplicable" />
                    </td>
                </tr>   
            </table>
        </div>        
