                ...
                <div class="version-fields">
                    <div class="version-row-1">
                        <div class="version-text">
                            <%= GetLocalResourceObject("CurrentVersionLabel") %>
                        </div>
                    ...
                    <div class="version-row-2">
                        <div class="version-text">
                            <%= GetLocalResourceObject("NewVersionLabel") %>
                        </div>
                        <div class="version-field">
                    ...
                    <div class="version-row-3">
                        <div class="version-text"><%= GetLocalResourceObject("EffectiveDateLabel") %></div>
                        <div class="version-field">
                    ...
                    <div class="version-row-4">
                        <div>
                            <%= GetLocalResourceObject("DetailsForHistoryLabel") %>
                        </div>
                        <div>
                            <asp:TextBox ID="txtHistory" runat="server" TextMode="MultiLine" style="resize: none; width: 218px; height: 82px;" meta:resourcekey="txtHistoryResource1" />
                        </div>
                    </div>
                </div>
                <div class="version-options">
                    <fieldset class="version-options-list">
                        <legend><%= GetLocalResourceObject("RevisionMethodLabel") %></legend>
                    ...
                    <fieldset class="version-options-list">
                        <legend><%= GetLocalResourceObject("RevisionTypeLabel") %></legend>
