<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ViewTraining.aspx.cs" Inherits="Paradigm3.ViewTraining" Async="true" %>
    ...
    <asp:ScriptManager ID="ScriptManager1" runat="server" />
        ...
        <ContentTemplate>
            ...
            <asp:Panel ID="pnlParaLink" runat="server" CssClass="toolbarButton" Visible="true">
                <asp:ImageButton ID="BtnParaLink" runat="server" ImageUrl="~/images/paralink.png" CommandArgument="ParaLink" ToolTip="View Record Para-Links&reg;" />
                <br />
            ...
            <asp:Panel ID="pnlTrainLink" runat="server" CssClass="toolbarButton" style="width: 62px;" Visible="false">
                <asp:ImageButton ID="BtnTrainLink" runat="server" ImageUrl="~/images/traininglink.png" ToolTip="View Training Record Links" />
                <br />
                <asp:Label ID="lblTrainLink" runat="server" Text="Training Link" />
            </asp:Panel>
			<asp:Panel ID="pnlAssessment" runat="server" CssClass="toolbarButton">
				<asp:ImageButton ID="BtnAssessment" runat="server" ImageUrl="~/images/assessment.png" ToolTip="Launch Competency Assessment" />
				<br />
				<asp:Label ID="lblAssessment" runat="server" Text="Assessment" />
			</asp:Panel>
            ...
            <asp:Panel ID="pnlClose" runat="server" CssClass="toolbarButton">
                <asp:ImageButton ID="BtnClose" runat="server" ImageUrl="~/images/exit.png" OnClick="ImageButton_Click" CommandArgument="CloseItem" ToolTip="Close Record" />
                <br />
        ...
        <div id="pnlRecordHeader">
            <table>
                ...
                <tr>
                    <td style="width: 80px; height: 24px; padding-left: 5px; text-align: left;">
                        <asp:Label ID="lblTraineeField" runat="server" Text="Trainee:" CssClass="recordLabel" />
                    </td>
                    <td style="height: 24px; width: 580px; text-align: left;" colspan="4">
                        <asp:TextBox ID="txtTraineeData" runat="server" Width="570px" ReadOnly="true" CssClass="ro_TitleControl" />
                    </td>
                </tr>
            </table>
        </div>
            ...
            <table style="padding: 0;">
                <tr>
                    <td style="width: 110px; padding: 10px 0 0 5px; vertical-align: top;">
                        <asp:Label ID="lblStep" runat="server" Text="Select Requirement:" CssClass="recordLabel" />
                    </td>
        ...
        <div id="pnlRecordStepName">
            ...
            <asp:Panel ID="pnlReqNotes" runat="server" CssClass="pnlInstructions">
                <asp:TextBox ID="txtReqNotes" runat="server" TextMode="MultiLine" />
            </asp:Panel>
        </div>
            ...
            <table style="width: 950px; padding: 0px; border: 0px solid Black;">
                <tr>
                    <td style="width: 150px; vertical-align: middle;">
                        <asp:Button ID="BtnFinishStep" runat="server" Text="Finish Requirement" Width="140px" OnClick="Button_Click" CommandArgument="FinishRequirement" />
                        <asp:ConfirmButtonExtender ID="cbeFinishStep" runat="server" ConfirmText="Finish Requirement:  Continue with the current operation?" TargetControlID="BtnFinishStep" />
                    </td>
