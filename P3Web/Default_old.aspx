<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default_old.aspx.cs" Inherits="Paradigm3.Default" EnableEventValidation="false" Async="true" meta:resourcekey="PageResource1" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div id="main">
            ...
            <div id="footer">
                <asp:LinkButton ID="linkVersion" runat="server" CssClass="lblVersion">
